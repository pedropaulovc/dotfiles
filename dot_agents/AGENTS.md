...
omp usage --json | jq '
  [.reports[] | {
    provider,
    account: (.metadata.email // .metadata.accountId),
    quotas: [.limits[] | {
      name: .label,
...
| Claude Opus 5    | Medium | 45                             | 2.19          | Workhorse for feature work                                                     |
...
| Claude Fable 5.1 | Medium | 49                             | 2.98          | Work coordinator, step-up if Opus high not effective                           |
